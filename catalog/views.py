...
def index(request):
	...
	num_genres_contains_sci = Genre.objects.filter(name__icontains='sci').count()
	...
	context = {
	    ...
	    'num_genres_contains_sci': num_genres_contains_sci,
	...
	def form_valid(self, form):
		try:
			...
			return HttpResponseRedirect(
				reverse('author-delete', kwargs={'pk': self.object.pkyhoho})
			)